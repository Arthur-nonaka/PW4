...
<body>
    ...
    <div class="div-conteudo">
        <form method="POST" action="./logica/processamentoTemp.php">
            ...
            <input type="text" name="temp" placeholder="Digite a temperatura">
            <select name="selection">
                <option value="celcius">Celcius para Fahrenheit</option>
                <option value="fahrenheit">Fahrenheit para Celcius</option>
            </select>
